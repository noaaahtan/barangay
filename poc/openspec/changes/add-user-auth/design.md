...
The Barangay Sta Ana Government Portal is currently fully public (noted as "No authentication in v1" in `project.md`). This change introduces JWT-based authentication and seeds initial users for the barangay system.
...
- **Seed users**: Initial users for barangay staff and citizens — all with a default password (e.g., `barangay2026`).
